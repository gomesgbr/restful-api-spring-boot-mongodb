package com.gomesgbr.workshopmongo.config;
...
import com.gomesgbr.workshopmongo.dto.AuthorDTO;
import com.gomesgbr.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu Viagem", "Vou viajarm para argentina!", new AuthorDTO(maria));
